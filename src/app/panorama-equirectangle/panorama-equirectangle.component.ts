...
@Component({
  selector: 'panorama-equirectangle',
  templateUrl: './panorama-equirectangle.component.html',
  styleUrls: ['./panorama-equirectangle.component.css']
})
export class PanoramaEquirectangleComponent implements AfterViewInit {
  /* STAGE PROPERTIES */
  ...
  private rotateCamera() {
    ...
    this.phi = new(<any>THREE).Math.degToRad(90 - this.latitude);
    this.theta = new(<any>THREE).Math.degToRad(this.longitude);
  ...
  private startRendering() {
    ...
    let component: PanoramaEquirectangleComponent = this;
