...
export class AnimateComponent implements OnInit, OnChanges, OnDestroy {
 ...
 private static readonly validZoomModes: string[] = ['hover', 'toggle', 'click', 'hover-freeze'];
    ...
    public set setThumbImage(thumbImage: string) {
    	console.info("has been initialized" + thumbImage);
    ...
    public set setZoomMode(zoomMode: string) {
        if (AnimateComponent.validZoomModes.some(m => m === zoomMode)) {
